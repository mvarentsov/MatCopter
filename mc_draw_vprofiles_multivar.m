function [leg_str, leg_h, data_val_lim, west_cutoff] = mc_draw_vprofiles_multivar (pr, varnames, opts)
    ...
    for i_pr = 1:numel (pr)
        for i_var = 1:numel (varnames)
            ...
            [cur_leg_h, cur_leg_str, cur_val_lim, west_cutoff] = mc_draw_vprofile_smart ...
                                       (pr(i_pr).asc, pr(i_pr).dsc, cur_varname, color, opts);
